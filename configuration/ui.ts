...
export const CHAT_HEADER: string = `Jeff Adams' AI Assistant`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Jeff Adams`;
export const CLEAR_BUTTON_TEXT: string = `Clear Chat History`;
export const PAGE_TITLE: string = `Jeff Adams' AI Assistant`;
